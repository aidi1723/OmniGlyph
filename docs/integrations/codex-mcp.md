...
```bash
<omniglyph-checkout>/.venv/bin/omniglyph-mcp
```

Or module mode:

```bash
<omniglyph-checkout>/.venv/bin/python -m omniglyph.mcp_server
```
...
```json
{
  "mcpServers": {
    "omniglyph": {
      "command": "<omniglyph-checkout>/.venv/bin/omniglyph-mcp",
      "cwd": "<omniglyph-checkout>"
    }
  }
}
```
...
```json
{
  "mcpServers": {
    "omniglyph": {
      "command": "<omniglyph-checkout>/.venv/bin/python",
      "args": ["-m", "omniglyph.mcp_server"],
      "cwd": "<omniglyph-checkout>",
      "env": {
        "PYTHONPATH": "<omniglyph-checkout>/src"
      }
    }
  }
}
